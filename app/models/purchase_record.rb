class PurchaseRecord < ApplicationRecord
  ...
  def save
    ...
    Address.create(postal_code: postal_code, region: prefecture_id, city: city, house_number: house_number, building_name: building_name, phone_number: phone_number, record_id: record.id)
  end
end
